...
structurellement les pthreads. En effet, les pthreads peuvent exploiter les \textbf{multiples cœurs} du processeur simultanément, tandis que nos threads utilisateur s'exécutent tous sur le
même cœur et ne bénéficient d’aucun parallélisme réel.
