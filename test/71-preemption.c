 ...
 * La durée du programme doit etre proportionnelle au nombre de threads donnés
 * en argument. L'affichage doit être une série d'id alternée dans un ordre plus
 * ou moin aléatoire, et non une suite de 0, puis de 1, puis de 2, ...
 *
 * support nécessaire:
 * - thread_create()
