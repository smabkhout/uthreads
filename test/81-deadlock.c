...
/* test de detection d'un deadlock lors d'un cycle de thread qui joignent tous
 * le suivant. main(th0) joine th1 qui joine th2 qui joine main. il faut qu'un
 * join renvoie EDEADLK quand il detecte le deadlock, et les autres renvoient 0
 * normalement.
 */
